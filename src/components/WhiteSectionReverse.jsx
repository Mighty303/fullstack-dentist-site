...
const WhiteSectionReverse = (props) => {
  ...
  return (
    <section className={props.isHeaderH1 ? `pt-44 pb-14` : "py-14"}>
      <div className="flex flex-col md:flex-row md:justify-center mx-auto w-[80%] md:w-[90%] gap-12 lg:gap-24 xl:gap-28">
        <div className="relative flex justify-center items-center md:w-[600px] lg:w-[700px]">
          {props.children}
        </div>
        <div className="flex flex-col gap-12">
          {/* Header & Content */}
          <HeaderTag className="text-3xl sm:text-3xl sm:text-4xl md:text-5xl font-bold">
...
export default WhiteSectionReverse;
